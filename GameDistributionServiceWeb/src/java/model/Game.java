...
//    private String Developer;
    ...
    public Game(int GameID, String Name, float Price, String Description, String Poster, List<Category> categorys) {
        this.GameID = GameID;
        this.Name = Name;
        this.Price = Price;
    ...
    public Game(int GameID, String Name, float Price, String Description, String Poster) {
        this.GameID = GameID;
        this.Name = Name;
        this.Price = Price;
        this.Description = Description;
