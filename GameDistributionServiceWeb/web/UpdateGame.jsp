                        ...
                        <div class="col-10 col-md-9 col-lg-7 col-xl-6">
                            <div class="card" style="border-radius: 15px;">
                                <div class="card-body p-5">
                                    <h2 class="text-uppercase text-center mb-5">Update Game</h2>
                                    ...
                                    <form action="updategame"  method="post" enctype='multipart/form-data'>
                                        ...
                                        <div class="form-outline mb-2">
                                            <input type="text" name ="id" value="${requestScope.game.gameID}"id="form3Example1cg" class="form-control form-control-lg" readonly=""  />
                                            <label class="form-label" for="form3Example1cg">Game ID</label>
                                        </div>
                                        <div class="form-outline mb-2">
                                            <input type="text" name ="name" value="${requestScope.game.name}"id="form3Example1cg" class="form-control form-control-lg" required=""  />
                                            <label class="form-label" for="form3Example1cg">Name</label>
                                        </div>

                                        <div class="form-outline mb-2">
                                            <input type="number" name="price" value="${requestScope.game.price} id="form3Example4cg" class="form-control form-control-lg" value="0" min="0"  />
                                            <label class="form-label" for="form3Example4cg">Price</label>
                                        </div>

                                        <div class="form-outline mb-2">
                                            <input type="text" name="decription" value="${requestScope.game.description}id="form3Example4cg" class="form-control form-control-lg" required="" />
